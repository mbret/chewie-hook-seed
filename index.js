...
class MyHook {
     ...
     *                 You are never obliged to use the helper as all it does is using chewie instance and provide more convenient methods for hooks.
     * @param {Object} helper.logger - A convenient logger you may use to display information. logger provide .info, .verbose, .waring, .error.
     *                 helper.logger is not really meant to be used as debug tool (although you can), you can use debug() for that. The logs will be displayed to
     *                 user depending of its config (info, verbose, warning, error)
     */
